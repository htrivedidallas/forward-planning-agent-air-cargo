...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        for efflit1 in actionA.effects:
            for efflit2 in actionB.effects:
                if efflit1 == ~efflit2:
                    return True
                else:
                    return False
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        for efflit1 in actionA.effects:
            for precon2 in actionB.preconditions:
                if efflit1 == ~precon2:
                    return True
                else:
                    return False
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        for precon1 in actionA.preconditions:
            for precon2 in actionB.preconditions:
                if self.parent_layer.is_mutex(precon1, precon2):
                    return True
                else:
                    return False
        #raise NotImplementedError
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        for act1 in self.parents[literalA]:
            for act2 in self.parents[literalB]:
                if not self.parent_layer.is_mutex(act1, act2):
                    return False
...
class PlanningGraph:
    ...
    def h_setlevel(self):
        ...
        while not self._is_leveled:
            litlayer = self.literal_layers[-1]
            goalsNotMutex = True
            if self.goal.issubset(litlayer):
                for goalA, goalB in combinations(self.goal,2):
                    if litlayer.is_mutex(goalA, goalB):
                        goalsNotMutex = False
                        break
                if goalsNotMutex:
